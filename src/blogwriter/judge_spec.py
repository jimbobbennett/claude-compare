...
CLAUDISM_CATEGORIES_V2: dict[str, str] = {
    "salience_flag": (
        'the prose asserts that something is important instead of showing '
        'why: "The interaction matters", "That disagreement matters", "a '
        'fact worth internalising", "worth knowing cold", "Crucially,", '
        '"deserves a moment", "the highest-leverage decision", "This is '
        'the one people feel". Not a flag: a sentence that states a '
        'concrete effect ("That omission changes how you read the map" is '
        'a claim about an effect, not an assertion of importance).'
    ),
    "contrast_reframe": (
        'one framing is negated and replaced with a sharper label or '
        'verdict, usually as a punchy pair: "Access is not ownership", '
        '"It\'s not cowardice, it\'s arithmetic", "That\'s not failure. '
        'That\'s satiety", "Frame generation is smoothness amplification, '
        'not performance", "The cold open is not backstory; it is a '
        'tension deposit", "Demos are short. Real work is not." The '
        'replacement is typically a crisp noun phrase that recasts the '
        'thing. Not a reframe: a scope qualifier ("it applies to all '
        'output tokens, not only thinking"), a correction whose second '
        'half is a number or evidence ("Most bags aren\'t lost. Delays '
        'account for 74%"), or an ordinary "but" clause.'
    ),
    "verdict_intensifier": (
        'a word or phrase that marks a claim as final, sincere or '
        'significant without adding information: "that\'s the whole '
        'point", "the honest answer", "the real business model", "that\'s '
        'not accidental", "That\'s it.", "which is exactly the point". Not '
        'an intensifier: an ordinary evaluation with content '
        '("straightforward and holds up well", "a real reason to choose '
        'one", "The industry\'s direction is clear: higher prices, more '
        'bundling").'
    ),
    "signpost": (
        'teases or defers an insight instead of delivering it: "Here\'s '
        'the part that bites people", "Here\'s why, and what to do '
        'instead", "The short answer is", "Think about what that means", '
        '"Two things worth internalising:", "Here\'s the structure", '
        '"Here\'s what actually happens", "Read that the other way round". '
        'Any "Here\'s the/what..." opener that sets up the next sentence '
        'counts. Not a signpost: a neutral structural transition ("First, '
        'a definition.", "More precisely:", "The following tools each '
        'offer...", "This post looks at why.", "In practice, that means a '
        'few habits:").'
    ),
    "gotcha_framing": (
        'a detail framed with trap vocabulary: "The trap is", "The catch '
        'is", "bites everyone", "catches people out", "Here is the thing '
        'nobody mentions". Not gotcha framing: a plain warning or '
        'condition with no trap framing ("Stays after 1 March are charged '
        'the new rates").'
    ),
    "stock_metaphor": (
        'a stock mechanical or economic metaphor from the well-worn set: '
        '"load-bearing", "doing a lot of work", "doing the heavy lifting", '
        '"earns its keep", "earns its counter space", "a useful lens", '
        '"the knob you aren\'t tuning", "sharp edges", "where it falls '
        'over", "where the real spending lives", "launder", "moving '
        'parts". Always tag any use of "load-bearing" (literal or '
        'figurative, hyphenated or not) and close variants like "bears the '
        'load" or "carries the weight". Not a stock metaphor: the ordinary '
        'dead metaphors of English and normal technical vocabulary '
        '("breaks down", "strain the context window", "an asset", "the '
        'same machinery", "buys scale", "workhorse", "for free", "burned '
        'rollouts", "opportunity cost", "under the hood").'
    ),
}
...
Below is a blog post. Find every instance of the rhetorical tics listed below, which mark prose as machine-written. Quote each one exactly, using the shortest span that shows the tic (usually one clause or sentence).
...
- Text inside quotation marks that the post attributes to someone else is not a tic.
